...
> Red Flag 1: There needs to be ladder structure in the barcode length plot since mm and hg are used

> Red Flag 2: The sequencing saturation is not 100% (1) for both mm and hg. 
...
> 2575 represent cells and 19612 represents gene or transcripts. 
...
> 1314 cells survived out of 2575 cells.
...
> Cells with a high percentage of mitochondrial reads are considered to be stressed or dying, and thus may be removed.
...
> X axis represent cells and Y axis represent genes.
...
> The genes have less variance and are more likely to represent noise 
...
> Fewer PC perform well at identifying major clusters. But t-SNE may not have enough variance to properly separate all relevant clusters or cell types.

How about only the first dimension? 

> Clusters that should be distinct may not appear separate and appear as a string, and differences between cells could be lost.

What happens when you use more dimensions?

> higher-numbered PCs often capture noise or technical variation. We can also potentially capture more subtle patterns, such as small differences between closely related cell populations or rare cell types.
